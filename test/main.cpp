...
int main()
{
    ...
    while (1)
    {
        ...
        std::cout << "Time: " << dt::hr(timeNow) << " ( " << dt::amOrPm(timeNow) << " ) : " << dt::min(timeNow) << " : " << dt::sec(timeNow) << " . " << dt::ms(timeNow) << " . " << dt::us(timeNow) << "\n";

        dt::set24h(true);

        std::cout << "Time: " << dt::hr(timeNow) << " : " << dt::min(timeNow) << " : " << dt::sec(timeNow) << " . " << dt::ms(timeNow) << " . " << dt::us(timeNow) << "\n";
